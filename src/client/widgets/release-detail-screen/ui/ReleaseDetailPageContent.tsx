...
export const RELEASE_DETAIL_MAIN_CLASS =
  "mx-auto max-w-5xl px-4 py-10 font-sans";

export type ReleaseDetailPageContentProps = {
  release: {
    id: number;
    discogsId: number;
    title: string;
...
export function ReleaseDetailPageContent(props: ReleaseDetailPageContentProps) {
      ...
      <section className="mt-12">
        ...
        <ul className="mt-4 divide-y divide-neutral-900">
          {props.reviews.length === 0 ? (
            <li className="py-4 text-neutral-500">No published reviews yet.</li>
          ) : (
