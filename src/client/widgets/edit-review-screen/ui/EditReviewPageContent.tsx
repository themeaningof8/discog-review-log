...
export const EDIT_REVIEW_MAIN_CLASS = "mx-auto max-w-3xl px-4 py-10 font-sans";

export type EditReviewPageContentProps = {
...
export function EditReviewPageContent(props: EditReviewPageContentProps) {
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-[140px_1fr]">
        ...
        <div className="space-y-6">
          ...
          {props.review.status !== "published" ? (
            <Form action={`/reviews/${props.review.id}/publish`} method="post">
              <button
                type="submit"
